...
INSERT INTO "new_Message" ("cacheCreationTokens", "cacheReadTokens", "compactedMessageIds", "content", "id", "instruction", "isAnalyzing", "isCompacted", "isExpanded", "isQuery", "isSummarizing", "model", "order", "paragraphSummary", "promptTokens", "role", "sceneAnalysis", "showThink", "storyId", "summary", "think", "timestamp", "tokensPerSecond", "totalTokens") SELECT "cacheCreationTokens", "cacheReadTokens", "compactedMessageIds", "content", "id", "instruction", "isAnalyzing", "isCompacted", "isExpanded", "isQuery", "isSummarizing", "model", "order", "paragraphSummary", "promptTokens", "role", "sceneAnalysis", "showThink", "storyId", "summary", "think", "timestamp", "tokensPerSecond", "totalTokens" FROM "Message";
DROP TABLE "Message";
