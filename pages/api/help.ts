...
const instructions = {
  next_paragraph: 'You are a writing assistant, try to give constructive advice. When prompted with a set of paragraphs, you will output a suggestion for the next paragraph of the story. There is no need to leave the paragraph open ended or make it needlessly positive in an otherwise grim situation.',
